...
- (void)commitDetailsWithParents:(DVTSourceControlWorkingCopy *)arg1 forRevision:(DVTSourceControlRevision *)arg2 path:(NSString *)arg3 completionBlock:(void (^)(DVTSourceControlLogItem *, NSArray *, NSDictionary *, NSError *))arg4;
...
- (void)exportFileWithParent:(DVTSourceControlWorkingCopy *)arg1 path:(NSString *)arg2 revision:(DVTSourceControlRevision *)arg3 status:(unsigned long long)arg4 completionBlock:(void (^)(NSURL *, NSURL *, NSError *))arg5;

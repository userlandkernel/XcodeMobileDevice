...
@class DVTAnalyticsCrashPointDistributionOptions, DVTAnalyticsDownloadMoreLogsOptions, DVTCrashPointAppStoreSource, DVTCrashPointFilter, DVTCrashPointParameters, NSArray, NSDate, NSMutableArray;

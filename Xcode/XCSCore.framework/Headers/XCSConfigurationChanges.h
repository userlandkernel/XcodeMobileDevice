...
- (id)initWithBuildConfiguration:(id)arg1 buildEnvironmentVariables:(id)arg2 builtFromClean:(id)arg3 codeCoveragePreference:(id)arg4 deviceSpecification:(id)arg5 exportsProductFromArchive:(id)arg6 disableAppThinning:(id)arg7 overrideToolchain:(id)arg8 performsAnalyzeAction:(id)arg9 performsArchiveAction:(id)arg10 performsTestAction:(id)arg11 periodicScheduleInterval:(id)arg12 scheduleType:(id)arg13 schemeName:(id)arg14 sourceControlBlueprint:(id)arg15 triggers:(id)arg16 validationErrors:(id *)arg17;

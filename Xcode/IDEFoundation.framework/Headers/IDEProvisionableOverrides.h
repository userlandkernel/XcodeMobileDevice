...
+ (id)overridesWithConfiguration:(id)arg1 profileSupport:(long long)arg2 team:(id)arg3 platform:(id)arg4 profileSpecifier:(id)arg5 certificateIdentifier:(id)arg6 bundleIdentifier:(id)arg7 entitlementsFile:(id)arg8 baseEntitlements:(id)arg9 entitlementsExpansion:(id)arg10 allowSigningWithoutTeamSelection:(id)arg11 signingRequired:(id)arg12;
+ (id)overridesWithConfiguration:(id)arg1 profileSupport:(long long)arg2 team:(id)arg3 platform:(id)arg4 profileSpecifier:(id)arg5 certificateIdentifier:(id)arg6 bundleIdentifier:(id)arg7 entitlementsFile:(id)arg8 baseEntitlements:(id)arg9 entitlementsExpansion:(id)arg10 allowSigningWithoutTeamSelection:(id)arg11 signingRequiresTeam:(id)arg12;
- (void).cxx_destruct;
